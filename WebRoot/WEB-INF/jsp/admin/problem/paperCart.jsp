						  ...
						  <div class="panel-body">
						  		<div class="row">
						  			<div class="col-xs-8">
										  ...
										  <h1>  <a href="${pageContext.request.contextPath}/admin/problem/problemAction!list?cur=1">  返回试题列表</a>  
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h3 class="modal-title" id="myModalLabel">确定要生成试卷吗？试卷一旦生成，不可修改</h3>
		      </div>
		      
		      <!-- 模态表单体 -->
		      <div class="modal-body">
		        	<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/paper/paperAction!save" role="form" method="post">
					  <div class="form-group">
					    <label  class="col-xs-2 control-label">试卷标题</label>
					    <div class="col-xs-10">
					      <input type="text" class="form-control" id="" name="paper.title">
					    </div>
					  </div>
					  <div class="form-group">
					    <label  class="col-xs-2 control-label">作者</label>
					    <div class="col-xs-10">
					      <input type="text" class="form-control" id="" name="paper.auther">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-xs-6">
							<div class="well">
								<p>年级:${sessionScope.grade}</p>
								<p>科目:${sessionScope.subject}</p>
							</div>
							<button type="submit" class="btn btn-warning btn-lg">生成试卷</button>
						</div>
					  </div>
