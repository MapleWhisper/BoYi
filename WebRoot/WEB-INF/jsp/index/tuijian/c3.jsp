<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
								...
								<s:iterator status="qwe"
									value="clist.{?#this.course.grade.indexOf('高中')!=-1}"
									var="classes">
										...
										<div class="panel panel-default">
											<div class="panel-body">
												<div class="row">
													...
													<div class="col-xs-8">
														<a target="_blank" href="${pageContext.request.contextPath}/course/indexAction!showClass?id=${classes.id}"> 
														<s:property value="#classes.name" />
														</a><br>
													</div>
												</div>
												<div class="row">
